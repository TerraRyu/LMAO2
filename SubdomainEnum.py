...
#                 results['subdomains'][name] = {'ip': address or 'N/A', 'sources': ['DNSRecon']}
#             else:
#                 if results['subdomains'][name]['ip'] == 'N/A':
#                     results['subdomains'][name]['ip'] = address or 'N/A'
#                 if 'DNSRecon' not in results['subdomains'][name]['sources']:
#                     results['subdomains'][name]['sources'].append('DNSRecon')
